...
if test "$PHP_OAUTH2" = "yes"; then
	...
	if ! test "x" = "x"; then
		PHP_EVAL_LIBLINE(, OAUTH2_SHARED_LIBADD)
	fi

	AC_DEFINE(HAVE_OAUTH2, 1, [Whether you have Oauth2])
	oauth2_sources="oauth2.c kernel/main.c kernel/memory.c kernel/exception.c kernel/debug.c kernel/backtrace.c kernel/object.c kernel/array.c kernel/string.c kernel/fcall.c kernel/require.c kernel/file.c kernel/operators.c kernel/math.c kernel/concat.c kernel/variables.c kernel/filter.c kernel/iterator.c kernel/time.c kernel/exit.c oauth2/storage/storageinterface.zep.c
	...
	PHP_SUBST(OAUTH2_SHARED_LIBADD)

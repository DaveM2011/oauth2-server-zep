...
ZEPHIR_INIT_CLASS(OAuth2_Controller_AuthorizeControllerInterface) {
	 ...
	 */
	zephir_declare_class_constant_string(oauth2_controller_authorizecontrollerinterface_ce, SL("RESPONSE_TYPE_AUTHORIZATION_CODE"), "code");

	zephir_declare_class_constant_string(oauth2_controller_authorizecontrollerinterface_ce, SL("RESPONSE_TYPE_ACCESS_TOKEN"), "token");
